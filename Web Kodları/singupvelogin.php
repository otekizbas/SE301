				<div id ="new_customer">
					...
					<img src="img/devam.png" style="width:76px; height:34px"/>
				</div>
				<div id ="returning_customer">
					...
					<h4>Password</h4>
					<input type="password" name="password" value="" placeholder="Password" id="input_password" class="form-control">
					
					<a href=""><h4>Forgotten Password</h4></a>
